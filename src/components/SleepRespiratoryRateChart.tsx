...
const SleepRespiratoryRateChart = ({ sleepIntervals }: Props) => {
  const heartRateData = aggregateTimeseriesData(sleepIntervals).respiratoryRate;
    ...
    datasets: [
      {
        ...
        color: (opacity = 1) => `rgba(99, 195, 255, ${opacity})`,
      },
    ],
  };
...
export default SleepRespiratoryRateChart;
